...
def get_all_profiles_and_atmos():
    subfoldername='plots_v4'
    base_path = Path('/home/harsh/OsloAnalysis/new_kmeans/all_data_inversion_rps/shocks_78')
    subfolder = base_path / subfoldername
    output_prof_name = subfolder / 'wholedata_rps_78_18_cycle_1_t_5_vl_5_vt_4_profs.nc'
    input_prof_name = base_path / 'wholedata_rps_78_18.nc'
    output_atmos_name = subfolder / 'wholedata_rps_78_18_cycle_1_t_5_vl_5_vt_4_atmos.nc'
