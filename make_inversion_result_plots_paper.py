...
if __name__ == '__main__':
    ...
    plot_data_for_result_plots(4, 12, 15, 21, 'D', index_alt=[7, 8, 9, 10], frame_alt=[11, 19, 20, 21], frame_res=[11, 14, 15, 16, 17, 18, 21])
    plot_data_for_result_plots(5, 57, 60, 29, 'E')
    ...
    plot_data_for_result_plots(9, 9, 12, 27, 'H', index_alt=[20, 21, 22], frame_alt=[8, 16, 17], frame_res=[8, 11, 12, 13, 14, 15, 17])
