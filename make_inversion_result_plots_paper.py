...
if __name__ == '__main__':
    ...
    plot_data_for_result_plots(8, 8, 12, 21, 'G', index_alt=[15, 16, 17, 18, 19], frame_alt=[6, 7, 15, 16, 17], frame_res=[6, 10, 11, 12, 13, 14, 17])
    plot_data_for_result_plots(9, 9, 13, 26, 'H', index_alt=[20, 21, 22], frame_alt=[8, 16, 17], frame_res=[8, 11, 12, 13, 14, 15, 17])
    ...
    make_time_evolution_plots(5, 57, 26, 30, 'E')
    make_time_evolution_plots(7, 7, 22, 17, 'F', index_alt=[11, 12, 13, 14], frame_alt=[6, 14, 15, 16], frame_res=[6, 10, 11, 12, 13, 15, 16])
    make_time_evolution_plots(8, 8, 25, 21, 'G', index_alt=[15, 16, 17, 18, 19], frame_alt=[6, 7, 15, 16, 17], frame_res=[6, 10, 11, 12, 13, 14, 17])
    make_time_evolution_plots(9, 9, 25, 26, 'H', index_alt=[20, 21, 22], frame_alt=[8, 16, 17], frame_res=[8, 11, 12, 13, 14, 15, 16, 17])
    # make_legend()
    # make_legend_average()
