...
def do_work(k, i, j):
    ...
    try:
        ...
        plt.savefig(write_path / 'plot_{}_{}_{}.png'.format(k, i + 662, j + 708), format='png', dpi=200)
        return Status.Work_done
    except Exception:
        sys.stdout.write('Failed for k: {}, i:{}, j:{}\n'.format(k, i, j))
